...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Settings', 'core' ),
	'page_title'           => esc_html__( 'Core Theme Settings', 'core' ),
...
$args['footer_text'] = '<br>'.esc_html__( 'Copyright Core &copy; 2021', 'core' );
...
require get_template_directory().'/options/opt_privacy.php';
